...
public class GHAppExtendedTest extends AbstractGitHubWireMockTest {
    ...
    public void createAppByManifestFlowTest() throws IOException {
        ...
        assertThat(appFromManifest.clientId(), equalTo("Iv1.1c63d0b87c03d42e"));
        assertThat(appFromManifest.webhookSecret(), equalTo("f4dafa9b05d8248d81f65f0e6cb108cb8bb76a0c"));
        assertThat(appFromManifest.clientSecret(), equalTo("f4b60603e85b3965492b393bca0809a914dcdf18"));
        assertThat(appFromManifest.pem(),
